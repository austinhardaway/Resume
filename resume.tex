...
\chap{PROJECTS}{
	...
	{Redesigned portolio to unify the information between my resume and my online professional presence. All content from both is defined and retrived from a central JSON file and rendered serverside.\\}
		...
		{Web App designed to help my 1301 students practice math with data types. It generates random values and then gives the student a series of expressions. The student is then asked for the resultant value and data-type (in Java).\\}
		}
